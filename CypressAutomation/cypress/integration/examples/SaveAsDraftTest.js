...
describe('My Second Test', function() {
    ...
    //    cy.get('#technologies_exp-7-technology')
       
    //    cy.get('#technologies_exp-7-technology option').each(($e1, index, $list) => {
    ...
    //     })
        ...
        kreiranjeOglasaPage.getSaveDraftButton()
        kreiranjeOglasaPage.getDraftSavedText()
